...
def parse_args():
    ...
    parser.add_argument('-dataset_name', type=str, default='Breast', help='the name of dataset to be finetuned')
    ...
    parser.add_argument('-train_img_list', type=str, default='train.csv')
    parser.add_argument('-val_img_list', type=str,default='val.csv')
    ...
    parser.add_argument('-epochs', type=int, default=300, help='the number of largest epochs to train')
    parser.add_argument('-sam_ckpt', type=str, default='medsam_vit_b.pth', help='the path to the checkpoint to load')
    ...
    parser.add_argument('-evl_chunk', type=int, default=64, help='evaluation chunk')
